...
<table class="table">
    ...
    <tbody>
    <c:forEach items="${listsp}" var="a" varStatus="i">
        <tr>
            ...
            <td>
                <a class="btn btn-warning" href="/sanpham/detal?id=${a.id}">CHI TIET</a>
            </td>
            <td>
                <a class="btn btn-warning" href="/sanpham/delete?id=${a.id}">XOA</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
