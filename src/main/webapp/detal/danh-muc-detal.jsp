...
<body>
<form action="/danhmuc/update?id=${detal.id}" method="post">



    <div class="mb-3">
        <label class="form-label">Ma </label>
        <input type="text" class="form-control" name="madanhmuc" value="${detal.madanhmuc}">
    </div>
    <div class="mb-3">
        <label class="form-label">Ten </label>
        <input type="text" class="form-control" name="tendanhmuc"  value="${detal.tendanhmuc}">
    </div>
    <div class="row">
