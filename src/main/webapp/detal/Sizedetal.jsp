...
<body>
<form action="/size/update?id=${detal.id}" method="post">



    <div class="mb-3">
        <label class="form-label">Ma </label>
        <input type="text" class="form-control" name="masize" value="${detal.masize}">
    </div>
    <div class="mb-3">
        <label class="form-label">Ten </label>
        <input type="text" class="form-control" name="tensize"  value="${detal.tensize}">
    </div>
    <div class="row">
