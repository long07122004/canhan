...
<body>
<form action="/sanpham/update?id=${spdetal.id}" method="post">
  <%@ taglib prefix = "c" uri = "http://java.sun.com/jsp/jstl/core" %>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" name="masanpham" value="${spdetal.masanpham}">
  </div>
  <div class="mb-3">
    <label class="form-label">Ten san pham </label>
    <input type="text" class="form-control" name="tensanpham" value="${spdetal.tensanpham}">
  </div>
  <div class="mb-3">
